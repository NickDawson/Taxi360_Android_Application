...
public class Ride implements Serializable {
    ...
    @Embedded
    @AttributeOverrides({
    @AttributeOverride(name="latitude", column=@Column(name="driver_end_latitude")),
    @AttributeOverride(name="longitude", column=@Column(name="driver_end_longitude"))})
    ...
    @Column(name = "passenger_start_address")
    private String passengerStartAddress;
    @Column(name = "driver_start_address")
    private String driverStartAddress;
    @Column(name = "driver_end_address")
    private String driverEndAddress;

    public String getPassengerStartAddress() {
        return passengerStartAddress;
    }

    public void setPassengerStartAddress(String passengerStartAddress) {
        this.passengerStartAddress = passengerStartAddress;
    }
