...
public class RideStartActivity extends Activity {
	...
	Runnable updateTextRunnable=new Runnable(){  
		 ...
		 String url = serverIP + "taxi360-war/api/ride/start";
		 ...
		 public void reachedPassenger(View view){
				...
				if(reached.getText().toString().equalsIgnoreCase("Notify Passenger"))
				{
				String url = serverIP + "taxi360-war/api/ride/reachedPassenger";
				Server.getInstance().connect("PUT", url, ride);
				reached.setText("Passenger Not found");
				}
				else{
					
					String url = serverIP + "taxi360-war/api/ride/passengerNotFound";
					Server.getInstance().connect("PUT", url, ride);
					finish();
	 ...
	 public void updatelocationtoserver() {
			String url = serverIP + "taxi360-war/api/ride/updateDriverLoc";
			
			
			driverGeo = setUpMap();
			ride.setPassengerEndLocation(driverGeo);
