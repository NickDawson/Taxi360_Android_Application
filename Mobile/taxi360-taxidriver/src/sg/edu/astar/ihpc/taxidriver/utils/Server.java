...
public class Server {
	...
	private void getRequest(String url) throws Exception{
		...
		try{
		httpGet.addHeader(AUTH_HEADER, SessionManager.getInstance().getDriver().getAccesskey());}catch(Exception e){Log.d(TAG, e.getMessage());}
	...
	private void postRequest(String url) throws ClientProtocolException, IOException  {
		...
		try{
		httpPost.addHeader(AUTH_HEADER, SessionManager.getInstance().getDriver().getAccesskey());}
		catch(Exception e)
		{
	...
	private void putRequest(String url) throws ClientProtocolException, IOException  {
		...
		try{
		httpPut.addHeader(AUTH_HEADER, SessionManager.getInstance().getDriver().getAccesskey());}catch(Exception e){Log.d(TAG, e.getMessage());}
		if(isBody)
	...
	private void deleteRequest(String url) throws ClientProtocolException, IOException{
		...
		try{
		httpDelete.addHeader(AUTH_HEADER, SessionManager.getInstance().getDriver().getAccesskey());}catch(Exception e){Log.d(TAG, e.getMessage());}
