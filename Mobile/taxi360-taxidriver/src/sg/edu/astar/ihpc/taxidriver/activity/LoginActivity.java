...
import sg.edu.astar.ihpc.taxidriver.entity.Credential;
...
//			Intent i = new Intent(context, DriverMainActivity.class);
...
//		}
		...
		final TextView view = (TextView) findViewById(R.id.sign_up);
	...
	public class UserLoginTask extends AsyncTask<Void, Void, Boolean> {
		...
		protected Boolean doInBackground(Void... params) {
			...
			String url = serverIP + "taxi360-war/api/auth/driver";
		...
		protected void onPostExecute(final Boolean success) {
			...
			if (success) {
				try {
					...
					driver=(new ObjectMapper()).readValue(response.getResponse(), Driver.class);
